    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dl_url_text', models.CharField(max_length=100, verbose_name='text for download url')),
            ],
        ),
        migrations.CreateModel(
            name='Soft',
            fields=[
                ...
                ('version', models.CharField(max_length=100, verbose_name='app version')),
        ...
        migrations.AddField(
            model_name='downlink',
            name='soft',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links', to='soft.Soft'),
        ),
    ]
